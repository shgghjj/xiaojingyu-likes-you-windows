...
object I18n {
    private val map = mapOf(
        ...
        "advanced_label" to mapOf("zh" to "高级设置", "en" to "Advanced"),
        "boredom_threshold_label" to mapOf("zh" to "主动联系无聊阈值", "en" to "Proactive threshold"),
        "daily_limit_label" to mapOf("zh" to "每日主动消息上限", "en" to "Daily proactive limit"),
        "step_limit_label" to mapOf("zh" to "每日自主步数上限", "en" to "Daily autonomy steps"),
